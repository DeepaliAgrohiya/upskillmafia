...
function Home() {
    const {shoes,cart,total, addToCart, increaseCounter, decreaseCounter} = useCart();
    return (
    <>
    <div className='flex'>
      ...
      <div className="p-4 w-1/3 bg-slate-200">
        <h2 className="text-xl font-bold mb-4">Cart</h2>
          <div>
            ...
            <Link className='bg-gray-800 text-white p-2 rounded-lg  ' to='/payment'>Go to Payment</Link>
          </div>
      </div>
    </div>    
